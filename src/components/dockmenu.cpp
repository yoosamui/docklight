...
Dock_menu::Dock_menu()
{
    ...
    m_item_menu_unminimize_all.set_label(_("Show all windows"));
    m_item_menu_minimize_all.set_label(_("Minimize all windows"));
    m_item_menu_close_all.set_label(_("Close all windows"));
