...
#include "Screen.h"
    ...
    void RootScreen::init(Gtk::Window* window)
    {
        if (window == NULL) {
    ...
    std::vector<MonitorObject*> RootScreen::get_Monitors()
    {
        return this->monitors;
    }

    void RootScreen::update()
    {
    ...
    MonitorObject* RootScreen::get_PrimaryMonitor()
    {
    ...
    MonitorObject* RootScreen::get_NextMonitor()
    {
        return this->nextMonitor;
    }

    gint RootScreen::get_MonitorsCount()
    {
